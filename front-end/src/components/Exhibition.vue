...
export default {
  ...
  mounted:function(){
  this.$store.state.combination.recommendation=this.$store.state.fund;
  this.$store.state.combination.expected_rate=this.$store.state.rate;
  this.$store.state.combination.risk_factor=this.$store.state.risk_factor;
